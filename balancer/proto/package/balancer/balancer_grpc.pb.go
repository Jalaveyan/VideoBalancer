...
func (c *balancerClient) Redirect(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
...
func (UnimplementedBalancerServer) Redirect(context.Context, *Request) (*Response, error) {
...
func _Balancer_Redirect_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BalancerServer).Redirect(ctx, req.(*Request))
	}
